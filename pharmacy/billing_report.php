      ...
      <table>
        ...
        <tbody>
            ...
            if(isset($_POST['submit'])){
                $start=$_POST['start'];
                $end=$_POST['end'];
                $sql="SELECT billing.date, billing_detail.* from billing_detail INNER JOIN billing on billing.id=billing_detail.bill_id WHERE billing.date BETWEEN '$start' AND '$end'";
            }
            else{
                $sql="SELECT billing.date, billing_detail.* from billing_detail INNER JOIN billing on billing.id=billing_detail.bill_id";
            }
