                ...
                <form>
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" id="discharge-patient-id" class="form-control" placeholder="Enter patient CNIC">
                        </div>
                         <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="discharge-doctor" class="form-control" placeholder="Enter doctor's name">
                    </div>
                    
                    <div class="form-group">
                        <label for="discharge-status">Discharge Status</label>
                        <select id="discharge-status" class="form-control">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="discharge-summary" class="form-control" rows="4" placeholder="Enter discharge summary"></textarea>
                    </div>
